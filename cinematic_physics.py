...
key = area_light("Key Light", (3.5, 6.5, -1.5), 1200, 5.0, (1.0, 0.75, 0.55))    
fill = area_light("Blue Fill", (-4.0, 3.0, 1.0), 850, 4.0, (0.25, 0.45, 1.0))    
rim = area_light("Rim Light", (0.0, 5.0, 6.0), 1100, 3.0, (1.0, 0.25, 0.08))    
